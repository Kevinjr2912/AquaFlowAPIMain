...
// useCases
const signUpUseCase = new SignUpUseCase(postgreSQLUser,bcryptPasswordHasher);
const signInUseCase = new SignInUseCase(postgreSQLUser, bcryptComparePassword, jwtGenerateToken);
